 ...
 *
 * <p>
 * To use, first set up SLF4J, then tell Velocity to use this class for logging
...
public class Slf4jLogChute implements LogChute {
	...
	/**
	 * Send a log message from Velocity. {@inheritDoc}
	 */
	...
	/**
	 * Send a log message from Velocity with an error. {@inheritDoc}
	 */
	...
	/**
	 * Checks whether the specified log level is enabled. {@inheritDoc}
	 */
